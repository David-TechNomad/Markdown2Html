...
import { BASIC_THEME_ID, CODE_THEME_ID, MARKDOWN_THEME_ID, LAYOUT_ID, BOX_ID, FONT_THEME_ID, MJX_DATA_FORMULA } from "./constant";
...
export const solveJuejinCode = html => {
  ...
  if (brMatchList) {
    for (const item of brMatchList) {
      const content = item.replace(/display: -webkit-box;/g, "display: block;") // -webkit-box替换为block
      .replace(/<br>/g, "\n<span/>") // <br>替换为\n<span/>
