...
let StyleEditor = (_dec = inject("content"), _dec2 = inject("navbar"), _dec(_class = _dec2(_class = observer(_class = (_temp = class StyleEditor extends Component {
  constructor(props) {
    super(props);
    ...
    this.changeStyle = editor => {
      ...
      const {
        themeList
      } = this.props.content; // focus状态很重要，初始化时被调用则不会进入条件
