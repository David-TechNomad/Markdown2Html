import { message } from "antd"; // In the following line, you should include the prefixes of implementations you want to test.

const indexedDB = window.indexedDB || window.mozIndexedDB || window.webkitIndexedDB || window.msIndexedDB; // DON'T use "var indexedDB = ..." if you're not in a function.
  ...
  initEvent(request) {
    return new Promise((resolve, reject) => {
      ...
      request.onsuccess = event => {
        ...
        console.log("成功初始化数据库"); // this.db = db;
