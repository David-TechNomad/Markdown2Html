...
import { LAYOUT_ID, BOX_ID, IMAGE_HOSTING_NAMES, IMAGE_HOSTING_TYPE, MJX_DATA_FORMULA, MJX_DATA_FORMULA_TYPE } from "./utils/constant";
...
let App = (_dec = inject("content"), _dec2 = inject("navbar"), _dec3 = inject("footer"), _dec4 = inject("view"), _dec5 = inject("dialog"), _dec6 = inject("imageHosting"), _dec(_class = _dec2(_class = _dec3(_class = _dec4(_class = _dec5(_class = _dec6(_class = observer(_class = (_temp = class App extends Component {
  constructor(props) {
    super(props);
    ...
    this.getInstance = instance => {
      instance.editor.on("inputRead", function (cm, event) {
        if (event.origin === "paste") {
          ...
          const {
            length
          } = cm.getSelections(); // my first idea was
    ...
    this.getStyleInstance = instance => {
      if (instance) {
  ...
  render() {
    ...
    const parseHtml = codeNum === 0 ? markdownParserWechat.render(this.props.content.content) : markdownParser.render(this.props.content.content);
    ...
    return React.createElement(appContext.Consumer, null, ({
      defaultTitle,
      onStyleChange,
      onStyleBlur,
      onStyleFocus,
    ...
    }, isSearchOpen && React.createElement(SearchBox, null), React.createElement(CodeMirror, {
    ...
    }))), isStyleEditorOpen && React.createElement("div", {
      id: "nice-style-editor",
      className: styleEditingClass
    }, React.createElement(StyleEditor, {
      onStyleChange: onStyleChange,
      onStyleBlur: onStyleBlur,
      onStyleFocus: onStyleFocus
    })), React.createElement(Dialog, null), React.createElement(EditorMenu, null)), React.createElement(Footer, null)));
  }
